...
const Result: React.FC<ResultProps> = ({ result, restartAssessment }) => {
  return (
    <div className={styles.body}>
      <div className={styles.header}>
        <div className={styles["logo-container"]}>
          ...
          <div className={styles["app-name"]}>VitalCheck</div>
        </div>
      </div>

      <div className={styles.content}>
        <div className={styles["result-circle"]}>
          <div className={styles["result-text"]} id="resultText">
            {result}
          </div>
        </div>

        <button className={styles["done-button"]} onClick={restartAssessment}>
          Done
        </button>
      </div>
    </div>
